...
$config['client_id'] = 'Ps0HSs9mBruaZHrj5T7FgNG25x';
...
$config['google_client_id'] = '554815054343-mrip66a0c4a9r4tmse3ohidmfk5d7pt8.apps.googleusercontent.comx';
$config['google_secret_id'] = 'm-9HZQDEuNhphErNkNXveh3J';
$config['google_call_back'] = base_url() . 'users/social_login/google_login/';


// Instagram API Credentials
$config['insta_client_id'] = 'cc0c6e3ffad5457eb811cf3bd99f0524x';
...
$config['linkedin_client_id'] = "81uy3lt801lccss";
