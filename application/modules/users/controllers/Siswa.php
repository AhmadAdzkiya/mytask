...
class Siswa extends MY_Controller
{
    ...
    public function createMember()
    {
        ...
        $data['page_title'] = "Pendaftaran aspirator DPRD ";
        $data['page_wallpaper'] = "";
        $data['page_sub_title'] = "Pendaftaran Aspirator DPRD ";
    ...
    public function add_user_json()
    {
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            if ($this->ion_auth->register($username, $password, $email, $additional_data, $group)) {
                ...
                // $headers = "Reply-To: DPRD  <dprd01@gmail.com>\r\n";
                $headers = "Return-Path: DPRD  <dprd01@gmail.com>\r\n";
                $headers .= "From: DPRD  <dprd01@gmail.com>\r\n";
                $headers .= "Organization: DPRD \r\n";
                ...
                // $headers = "From: dprd01@gmail.com\r\n";

                $subject = "DPRD  - Verifikasi Akun";
                $message = "
                <!DOCTYPE html>
                <html>
                <head>
                ...
                <body>
                <div style='text-align:center'><img style='width:90px; height:95px;' src='https://dprd.kab.go.id/v2/public/b-asset/img/dprd_logo.png'></div>
                <div style='background-color:#f7f7f7; width:100%; padding:1rem'>
                <h1>Selamat datang di DPRD </h1>
    ...
    public function vrf($base64)
    {
        ...
        $data['top1'] = "dprd/v_top_prioritas";
        $data['page_title'] = "Verifikasi email aspirator DPRD ";
        $data['page_wallpaper'] = "";
        $data['page_sub_title'] = "Verifikasi Aspirator DPRD ";
        $data['page'] = "dprd/v_kontainer";
        $data['data'] = "";
    ...
    public function resendEmailVerification()
    {
        ...
        $subject = "DPRD  - Kirim Ulang Verifikasi Akun";
        $message = "
        <!DOCTYPE html>
        <html>
        <head>
