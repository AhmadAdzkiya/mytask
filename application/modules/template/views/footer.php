         ...
         <div class="tab-content">
            <div class="tab-pane tab-chat active" id="tab1" role="tabpanel">
                     ...
                     <div class="be-scroller-chat">
                        <div class="content">
                           ...
                           <div class="contact-list contact-list-recent">
                              <div class="user"><a href="#"><img src="<?= bs() ?>public/b-asset/img/avatar1.png" alt="Avatar">
                              ...
                              <div class="user"><a href="#"><img src="<?= bs() ?>public/b-asset/img/avatar2.png" alt="Avatar">
                              ...
                              <div class="user"><a href="#"><img src="<?= bs() ?>public/b-asset/img/avatar3.png" alt="Avatar">
                           ...
                           <div class="contact-list">
                              <div class="user"><a href="#"><img src="<?= bs() ?>public/b-asset/img/avatar4.png" alt="Avatar">
                                    <div class="user-data2"><span class="status"></span><span class="name">Mike Bolthort</span></div>
                                 </a></div>
                              <div class="user"><a href="#"><img src="<?= bs() ?>public/b-asset/img/avatar5.png" alt="Avatar">
                                    <div class="user-data2"><span class="status"></span><span class="name">Maggie jackson</span></div>
                                 </a></div>
                              <div class="user"><a href="#"><img src="<?= bs() ?>public/b-asset/img/avatar6.png" alt="Avatar">
               ...
               <div class="chat-window">
                  <div class="title">
                     <div class="user"><img src="<?= bs() ?>public/b-asset/img/avatar2.png" alt="Avatar">
...
<script src="<?= bs() ?>public/assets/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.js" type="text/javascript"></script>
<script src="<?= bs() ?>public/assets/plugins/form-select2/select2.js" type="text/javascript"></script>


<!-- editor -->
<!-- <script src="<?= bs() ?>public/b-asset/js/app-form-wysiwyg.js" type="text/javascript"></script> -->
<!-- <script src="<?= bs() ?>public/b-asset/lib/summernote/summernote-ext-beagle.js" type="text/javascript"></script> -->

<script src="<?= bs() ?>public/b-asset/lib/summernote/0_8_18/summernote-bs4.min.js" type="text/javascript"></script>
<!-- plugin editor -->
<script src="<?= bs() ?>public/b-asset/lib/summernote/0_8_18/plugin/hello/summernote-ext-hello.js" type="text/javascript"></script>


<script src="<?= bs() ?>public/b-asset/lib/orgchart/js/orgchart.min.js"></script>
