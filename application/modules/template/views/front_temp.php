...
<head>
	<meta charset="utf-8" />
	<title>Situs Informasi dan Pantauan COVID-19 </title>
			...
			<header id="topNav">
				<div class="container">
					...
					<a class="logo pull-left" href="/">
						<img src="https://.kab.go.id/public/.png" alt="" />
					</a>
	...
	-->
		...
		<section>
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<img class="img-responsive" src="<?php echo base_url() ?>public/lapcovid18.JPG" alt="" />
					</div>
				</div>
					...
					<div class="col-md-12">
						...
						<ul>
							<li><a href="<?php echo base_url() ?>public/SE_BUPATI_TTG_COVID-19 - RESMI.pdf" target="_blank">
									SURAT EDARAN BUPATI TENTANG KEWASPADAAN DAN PENCEGAHAN TERHADAP VIRUS DISEASE 2019 (Covid-19)
								</a>
							</li>
							<li>
		...
		<footer id="footer">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4">
						<a href="https://connect.kab.go.id/harga_pasar" target="_blank"><img style="height: 75px;" class="img-responsive" src="<?php echo base_url() ?>public/bkonek.png" alt=""></a>
					</div>
				</div>
