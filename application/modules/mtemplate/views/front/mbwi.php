...
<head>
    ...
    <link href="<?php echo base_url() ?>templates/<?php echo $tem; ?>/assets/css/animate.css" rel="stylesheet" type="text/css" />

    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>templates/<?php echo $tem; ?>/assets/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>templates/<?php echo $tem; ?>/assets/css/font-awesome.css">


    <link href="<?= base_url('templates//owl/owlcarousel/assets/owl.carousel.min.css'); ?>" rel="stylesheet" type="text/css" />
    <link href="<?= base_url('templates//owl/owlcarousel/assets/owl.theme.default.min.css'); ?>" rel="stylesheet" type="text/css" />

    <!-- ogchart -->
    <link href="<?= base_url('public/b-asset/lib/orgchart/css/orgchart.min.css'); ?>" rel="stylesheet" type="text/css" />
...
<body class="smoothscroll bg-abu">
    ...
    <!-- wrapper -->
    <div id="wrapper">
        <?= $this->load->view("devtemplate/front/main_nav2"); ?>


        <?php isset($top1) ? $this->load->view($top1) : $this->load->view('devtemplate/front/top_'); ?>
    ...
    <script src="<?php echo base_url() ?>templates//app.js"></script>
    <script src="<?php echo base_url() ?>templates//jquery.bootpag.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url() ?>templates/<?php echo $tem; ?>/assets/js/jquery.dataTables.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url() ?>templates/<?php echo $tem; ?>/assets/js/dataTables.bootstrap4.min.js"></script>
