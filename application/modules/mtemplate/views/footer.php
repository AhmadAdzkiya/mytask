...
<script src="<?= bs() ?>public/b-asset/js/all.min.js" type="text/javascript"></script>
<script src="<?= bs() ?>public/b-asset/js/solid.min.js" type="text/javascript"></script>
<script src="<?= bs() ?>public/b-asset/js/fontawesome.min.js" type="text/javascript"></script>
...
<script src="<?= bs() ?>public/b-asset/lib/summernote/summernote-bs4.min.js" type="text/javascript"></script>
...
<script src="<?= bs() ?>public/b-asset/lib/smartwizard/js/jquery.smartWizard.min.js" type="text/javascript"></script>
