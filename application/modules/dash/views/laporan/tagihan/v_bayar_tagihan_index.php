...
<div class="be-content">
    <div class="page-head">
        <h4 class="page-head-title">Pembayaran Tagihan Siswa<span class="page-head-sub-title"></span>
        </h4>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card card-border-color card-border-color-primary">
                    ...
                    <div>Form Pembayaran Tagihan</div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-lg-12">
                                <div class="container-fluid">
                                    <?php $this->load->view("v_cari_bayar_siswa_content"); ?>
                                </div>
                            </div>
                        </div>
