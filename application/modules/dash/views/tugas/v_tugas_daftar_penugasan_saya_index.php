...
<div class="be-content">
    ...
    <div class="page-head">
        <h4 class="page-head-title">Daftar Penugasan saya<span class="page-head-sub-title"></span>
        </h4>

        <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
                <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>">Dashboard </a></li>
                <li class="breadcrumb-item"> <a href="<?php echo base_url(); ?>/dash/tugas/tugas/penugasansaya"> Daftar
                        Tugas</a></li>
            </ol>
        </nav>
...
$(() => {
    ...
    $('#tableXXP').DataTable({
        ...
        serverSide: true,
        ajax: {
            "url":`${site}/dash/tugas/tugas/listpenugasan`,
            "type": "POST",
            // "data": 
            // "success" : (src)=>{
            //     console.log(src)
