...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= bs() ?>public/b-asset/css/dprddev.css">
        ...
        <div class="row">
            <div class="img-holder">
                ...
                <div class="info-holder">
                    <img style="height:8rem; width:7rem; margin:auto;" src="<?= bs() ?>public/b-asset/img/dprd_logo.png">
                    <br>
                    <br>
                    <h1>DASHBOARD</h1>
                    <h5>ASPIRATOR</h5>
            ...
            <div class="form-holder">
                <div class="form-content">
                    ...
                    <div class="form-items" style="z-index:999; max-width:380px">
                        <!-- <div style="z-index:0; position:fixed; bottom:0px; right:0px; width:320px; height:400px; background-image:url('<?= bs() ?>public/b-asset/img/dev_gajah_oling_soft.png'); background-size:cover; background-repeat:no-repeat; background-position:top center;">
                    </div> -->
                        <div class="website-logo-inside">
                            <a href="#">

                                <div class="logo">
                                    <img class="logo-size" src="<?= bs() ?>public/b-asset/img/dprd_logo.png" alt="">
                                </div>
                        ...
                        <div class="page-links">
                            ...
                            ?>
                            <a href="#" class="active"><i class="fas fa-key"></i> Masuk Dashboard Aspirator</a>
                            <?php
                        ...
                        <form id="login_form" action="<?= base_url('users/auth/login') ?>" method="post">
                            <input class="form-control" type="email" name="identity" id="identity" style="font-weight:bold" placeholder="Alamat email" required>
                            <input class="form-control" type="password" name="password" style="font-weight:bold" placeholder="Password" required>
                        ...
                        <a style="color:#ffffff; margin-right:1rem;" href="<?= base_url(); ?>">Home</a>
                        <a style="color:#ffffff" href="<?= base_url() . 'users/aspirator/createmember'; ?>">Daftar</a>
