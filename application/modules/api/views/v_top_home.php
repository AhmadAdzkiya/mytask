...
<div class="hero-wrap img" style="background-attachment: fixed; background-image: url('<?= bs() ?>public/b-asset/img/ijen-bwidev.jpg');">

  <div style="width:100%; diplay:tabel; align-items:center; text-align:center"> 
    <img src="<?= bs() ?>public/b-asset/img/partly-cloudy-day-64-bwidev.png" class="icon-weather">
  </div>
