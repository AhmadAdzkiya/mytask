...
<!-- include summernote css/js -->
    ...
    <link href=" <?= bs() ?>public/assets/plugins/bootstrap-datetimepicker/css/bootstrap-datetimepicker.css" rel="stylesheet">
                        ...
                        <div style="display: flex; flex-direction:row;">
                            ...
                            <div id="title-teks" class="logo-beranda">
                                <span style="color:black">
                                    <span class="title-teks-sub-a" style="color:black"></span><br>
                                    <span class="title-teks-sub-b" style="color:black">Dashboard x</span>
                                </span>
                            </div>
