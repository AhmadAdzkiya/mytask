...
<!--[if gt IE 9]><!-->	<html> <!--<![endif]-->
	<head>
	 ...
	 <!--
			<link rel="stylesheet" type="text/css" href="https://corona.banyuwangikab.go.id/public/b-asset/lib/perfect-scrollbar/css/perfect-scrollbar.css" />

	    <link rel="stylesheet" type="text/css" href="https://corona.banyuwangikab.go.id/public/b-asset/lib/material-design-icons/css/material-design-iconic-font.min.css" />

	    <link rel="stylesheet" href="https://corona.banyuwangikab.go.id/public/b-asset/css/app.css" type="text/css" />

			<script src="https://corona.banyuwangikab.go.id/public/b-asset/lib/jquery/jquery.min.js" type="text/javascript"></script>
		  -->
