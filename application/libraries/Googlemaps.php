...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyCigXv9h7LYXzOY2qdAa8peFPL-Pxaqyh8'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	function create_map()
	{
		...
		if ($this->loadGeoJson) {
			...
			$this->output_js_contents .= '
				map.data.loadGeoJson("'.$this->loadGeoJson.'");
				';
		}
